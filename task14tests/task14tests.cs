...
public class DefiniteIntegralTests
{
    ...
    public void Test_QUADfunction_CorrectAnswer()
    {
        ...
        Assert.Equal(9.0, DefiniteIntegral.Solve(0, 3, QUAD, 1e-4, 4), 3);
    }
    ...
    public void Test_ZeroInterval_ReturnsZero()
    {
        ...
        Assert.Equal(0.0, DefiniteIntegral.Solve(5, 5, func, 1e-4, 2), 4);
    }
    ...
    {
        var X = (double x) => x;
        Assert.Equal(50.0, DefiniteIntegral.Solve(0, 10, X, 1.0, 3), 4);
    }
    ...
    {
        var exp = Math.Exp;
        Assert.Equal(Math.E - 1, DefiniteIntegral.Solve(0, 1, exp, 1e-6, 16), 4);
    }
}
